...
const MANAGERS = [
  ...
  // },
  {
    ...
    golfers: {
      ...
      us_open: ["Tommy Fleetwood", "Russell Henley", "Adam Scott", "Wyndham Clark"],
      the_open: [],
    },
  },
  {
    ...
    golfers: {
      the_masters: [],
      pga_championship: [],
      us_open: ["Jon Rahm", "Maverick McNealy", "Bryson DeChambeau", "Jake Knapp"],
      the_open: [],
    },
  },
    {
    ...
    golfers: {
      the_masters: [],
      pga_championship: [],
      us_open: ["Sam Burns", "Xander Schauffele", "Ben Griffin", "Shane Lowry"],
      the_open: [],
    },
  },
];
